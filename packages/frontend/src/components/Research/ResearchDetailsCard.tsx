...
import type { CompanyProfile } from "@/models/CompanyProfileModel";
...
export default function ResearchDetailsCard({
	companyProfile,
						...
						>
							{[
								...
								// { key: 'industry', label: 'Industry', value: companyProfile['industry'] },
								{
									...
									value: fnShortenNumber(
										companyProfile["shareOutstanding"] * 10 ** 6,
									),
								},
								{
									key: "marketCap",
								...
								},
								{
									key: "ipo",
									label: "IPO Date",
									value: moment(companyProfile["ipo"]).format("ll"),
								},
							].map(
								(x) =>
									x.value && (
										<ListItem
											key={x.key}
											secondaryAction={<ListItemText primary={x.value} />}
											divider
										>
											<ListItemText
												primary={x.label}
