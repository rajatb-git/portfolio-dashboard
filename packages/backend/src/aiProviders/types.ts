...
Then synthesize and commit to an explicit call. Be specific and quantitative — cite the actual numbers from the data, including the peer comparison when present. If a data point is missing, say so rather than inventing it.
...
Respond ONLY with valid JSON matching this exact schema (no markdown, no code fences):
{
  ...
  "rationale": "1-2 sentence justification for the rating, citing the strongest supporting evidence",
  "keyPoints": ["point 1", "point 2", "point 3"],
  "risks": ["risk 1", "risk 2"],
  "catalysts": ["catalyst 1", "catalyst 2"]
}
Take a clear stance in the "rating" — commit to buy, hold, or sell based on the weight of evidence; do not default to hold to avoid a call. Keep each point to one specific, number-backed sentence.`;
